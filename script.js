const quizData = [
    {
        ...
        options: ['On earth', 'In space', 'Under sea', 'In rubbish bins'],
        answer: 'In rubbish bins',
    },
    {
        question: 'Who is Tony Stark’s father??',
        options: ['Howard Stark', 'Batman yalk', 'The Flash', 'Neptune'],
        answer: 'Howard Stark',
    },
    {
        question: 'What does S.H.I.E.L.D. stand for??',
        options: [' Strategic Homeland Intervention, Enforcement and Logistics Division', 'Intervention Enforcement and Logistics Division', 'France', 'Intervention'],
        answer: ' Strategic Homeland Intervention, Enforcement and Logistics Division',
    },
    {
        question: 'What type of doctor is Doctor Strange?',
        options: [' A neurosurgeon', ' Peggy Carter', 'Lieutenant Trouble', 'Makalu'],
